...
def build_mediapipe_skeleton(skel_3d_data, pose_estimation_markers=mediapipe_indices,
    ...
    for frame in track(range(num_frames), 'Building Mediapipe Skeleton'):
        ...
        for connection in pose_estimation_connections:
            ...
            joint_1_coordinates = get_joint_coordinates_from_name(frame, joint_1_name, pose_estimation_markers,
                                                                  skel_3d_data)
            joint_2_coordinates = get_joint_coordinates_from_name(frame, joint_2_name, pose_estimation_markers,
                                                                  skel_3d_data)
    ...
    return this_frame_connection_dict
    f = 2
